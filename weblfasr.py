...
class AsrRequest(object):
    def __init__(self, upload_file_path):
        self.appid = '322a28d9'
        self.secret_key = '82e4b7c82e37092a2d050a348aea8495'
    ...
    def request(self):
        ...
        # 6. 提取文本
        data_arr = json.loads(result['data'])
        text_arr = []
        for d in data_arr:
            text_arr.append(d['onebest'])
